    ...
    <section class="hero" id="home">
      <main class="content">
        <h1>
          Mari Nikmati
          <br />
          <span>Mie </span> & <span>Kopi</span>
        </h1>
        <p>
          "Ketika lelah menghampiri, saatnya berhenti sejenak. Ngopi dan makan
          bersama bisa mengembalikan energi dan semangatmu."
        </p>
        <a href="login.php" class="cta" onclick="checkLogin(event)"
          >Login Untuk Beli</a
        >
      </main>
    </section>
    ...
    <section>
      <section id="about" class="about">
        ...
        <div class="row">
          ...
          <div class="content">
            <h3>Sebuah Kenangan yang Menghangatkan</h3>
            <p>
              Di Warung Kopi [Nama Warung Kopi Anda], kami percaya bahwa
              secangkir kopi dapat menjadi lebih dari sekadar minuman. Kami
